  ...
  return (
    <footer className="gradient text-center">
      <div className="m-5 mx-auto">
        <div className="flex flex-col md:flex-row py-6 mx-auto justify-around">
          <div className="flex-1">
            <p className="uppercase font-extrabold md:mb-4 text-white">
              Feature
            </p>
      ...
      <div className="mx-auto m-10">
        <h3 className="  text-white text-center text-xs md:text-sm">
          Menara Tower Lt X Jalan TB Simatupang No. 88, Jakarta Selatan,
          Indonesia
        </h3>
        <h3 className="  text-white text-center text-xs md:text-sm">
          @ PT Digital Tax Indonesia{" "}
        </h3>
      </div>
    </footer>
  );
