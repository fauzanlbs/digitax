    ...
    <Layout>
      ...
      <div className="container mx-auto">
        <div className="text-center px-3 lg:px-0">
          <h1 className="my-4 text-2xl md:text-3xl lg:text-5xl font-black leading-tight text-gray-800">
            Your Tax Solutions, Online!
          </h1>
          <p className="leading-normal text-gray-800 text-base md:text-xl lg:text-1xl mb-8">
            Deskripsi singkat tentang apa yang Digitax lakukan, serta services
            dan products apa yang tersedia untuk klien
          </p>
        </div>
      ...
      <section className="bg-indigo-400 border-b py-8 rounded-md shadow-2xl shadow-inner">
        <div className="container mx-auto flex flex-wrap pt-4 pb-12">
          <h2 className="w-full my-2 text-2xl md:text-5xl font-black leading-tight text-center text-gray-800">
      ...
      <h2 className="w-full my-2 text-3xl md:text-5xl font-black leading-tight text-center text-gray-800 mt-20">
        Products & Services
      </h2>
      <p className="w-full my-2 text-based md:text-2xl font-black leading-tight text-center text-gray-800">
        Berisi Highlight Products & Services yang ada di Digitax
      </p>
      ...
      <section className="text-center mb-20">
        ...
        <p className="leading-loose">
          Kumpulan Peraturan Perpajakan yang dapat diakses setiap saat melalui
          smartphone anda
        </p>
